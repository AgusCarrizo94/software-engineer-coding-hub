...
// But in development if we do not specify the below line assignment, everytime the hot reloads executes, a new PrismaClient instance will be created. This would trigger a multiple Prisma instances error.
